...
## 📌 Project Overview
* [cite_start]**Target:** Precise $90^{\circ}$ positioning ($\approx 515$ encoder counts) with minimal overshoot and fast settling time[cite: 30].
...
![System Overview](Result/System%20Overview.png)
...
![Oscilloscope Measurement](Result/Oscilloscope%20Measurement.png)

### PID Controller Design
[cite_start]Automated optimization was conducted via MATLAB's `pidtune()` [cite: 34][cite_start], then manually adjusted to suppress derivative quantization noise in hardware[cite: 655]:

| Parameter | [cite_start]Continuous (MATLAB) [cite: 501] | [cite_start]Discrete (Firmware, $Ts = 10\text{ ms}$) [cite: 501] |
| :--- | :--- | :--- |
| **Kp** | [cite_start]4.1671 [cite: 501] | [cite_start]4.1671 (unchanged) [cite: 501] |
| **Ki** | [cite_start]4.2523 [cite: 501] | [cite_start]0.0425 (x Ts) [cite: 501] |
| **Kd** | [cite_start]91.17 [cite: 501] | [cite_start]3.0 (adjusted for noise) [cite: 501] |

### Simulation Results
[cite_start]The optimized PID parameters yielded a **49% faster settling time** compared to manual tuning[cite: 591, 592]:

![Manual vs. Optimized PID Response](Result/Manual%20vs.%20Optimized%20PID%20Resp....png)
...
### Telemetry Profiles
Below are the real-time telemetry waveforms captured directly from the physical prototype:

#### 1. Hardware Setup
![Hardware Prototype](Result/Hardware%20Prototype.png)

#### 2. Position & Target Tracking
* **Target Position (Step Input):**
  ![Target Position](Result/Real-time%20Telemetry%20Data%20-%20Targ....png)
* **Actual Encoder Position:**
  ![Encoder Position](Result/Real-time%20Telemetry%20Data%20-%20Enco....png)

#### 3. Control Effort & Error
* **Bidirectional PWM Output:**
  ![PWM Output](Result/Real-time%20Telemetry%20Data%20-%20PW....png)
* **Transient Position Error:**
  ![Position Error](Result/Real-time%20Telemetry%20Data%20-%20Error....png)
